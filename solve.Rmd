...
* replace "you win $100" with "your total reaches $100"
...
Turns out, if the coin is far from fair, the outcome is quite certain. Closer in on 50/50, though, we see some variation.
...
x_high = .5025
p <- ggplot(data = data.frame(p = 0), mapping = aes(x = p)) +
  scale_x_continuous(breaks = seq(x_low, x_high, 0.000125), limits = c(x_low, x_high)) +
